  ...
  if (downloadPdfBtn) {
    downloadPdfBtn.addEventListener('click', () => {
      ...
      const proceedWithPDF = () => {
        try {
          // Native dimensions of the template image (1024x723 for the 30-day template)
          ...
          const nameY = nativeHeight * 0.500;
          ...
          doc.save(`Aadhya_14_Days_AI_Training_Certificate_${safeName}.pdf`);
